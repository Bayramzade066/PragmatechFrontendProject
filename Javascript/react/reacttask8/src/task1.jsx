...
function App() {
  ...
  return (
    <div className="App">
      <h1>QR code olaraq çevirmek istediyiniz melumatı daxil edin.</h1>
      <div className="qrcode">
        <img src={`http://api.qrserver.com/v1/create-qr-code/?data="${inputvalue}"&size=150x150&bgcolor=${color}`} alt="" />
      </div>

      <form action="#">
        <input ref={inputdata} id='inputdata' placeholder='melumati daxil edin..' type="text" />
        <div id="radio__wrapper">
